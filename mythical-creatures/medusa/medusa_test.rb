...
class MedusaTest < Minitest::Test
  ...
  def test_can_only_have_three_victims
    ...
    assert_equal victim1, medusa.statues.first
  end
  ...
  def test_if_a_fourth_victim_is_stoned_first_is_unstoned
    ...
    assert_equal 3, medusa.statues.length
    assert_equal victim1, medusa.statues.first
    assert_equal victim3, medusa.statues.last

    medusa.stare(victim4)
    assert_equal 3, medusa.statues.length
    assert_equal victim2, medusa.statues.first
    assert_equal victim4, medusa.statues.last
  end
end
